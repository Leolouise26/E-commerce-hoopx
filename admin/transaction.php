...
#dash table td:nth-child(4) {
    font-size: 10px; /* Adjust font size for the product name column */
}
        /* Pagination styles */
        .pagination {
...
<body>
    ...
    <?php echo $row['approved']; ?>
                            ...
                            <td>
                                <button class="delivered-btn" data-transaction-id="<?php echo $row["transaction_id"]; ?>"><i class="fa fa-gift" aria-hidden="true"></i></button>
                                <button class="being-delivered-btn" data-transaction-id="<?php echo $row["transaction_id"]; ?>"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                            </td>
                        </tr>
                        <?php
                    }
